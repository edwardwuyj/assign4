...
import { getImageUrl, TV_AIRING_TODAY_ENDPOINT, type ImageCell, type TvListResponse } from '@/core';
...
export const AiringTodayView = () => {
  ...
  const { data, error } = useTmdb<TvListResponse>(TV_AIRING_TODAY_ENDPOINT, { page });
