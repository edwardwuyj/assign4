...
import { getImageUrl, TV_ON_THE_AIR_ENDPOINT, type ImageCell, type TvListResponse } from '@/core';
...
export const OntheAirView = () => {
  ...
  const { data, error } = useTmdb<TvListResponse>(TV_ON_THE_AIR_ENDPOINT, { page });
